# Gap status — `mycelium-std-runtime`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-std-runtime` |
| **Role** | std.runtime hypha concurrency |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-std-runtime-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | none |
| **Related issues** | No I/O reactor; compose with host floor |
